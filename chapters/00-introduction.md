...
This book covers corporate finance with AI in the analyst's toolkit. The chapter-level *A note about AI* sections address local methods; the framing chapter has the most substantive treatment. The unifying principle: **the model knows finance; it does not know your company.** It can explain WACC, walk through capital structure theory, derive option valuation, and produce frameworks for M&A diligence. It cannot replace the working CFO's view of the firm's actual capital position, the board's actual risk appetite, the bank's actual willingness to lend, or the regulatory environment that is binding now. Use the model for the theory. The recommendation belongs to the analyst who will defend it.
